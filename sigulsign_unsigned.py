...
CLIENTCERT = os.path.expanduser('~/.koji/usercert.pem')
...
KEYS = {
    'clearos-6': {'id': '5f17cd5a', 'v3': True},
    'clearos-6-testing': {'id': 'ff5064bd', 'v3': True},
    'clearos-7': {'id': '4533fd4b', 'v3': True},
    'clearos-7-testing': {'id': 'c4a41eab', 'v3': True},
}
...
class KojiHelper(object):
    def __init__(self, arch=None):
        if arch:
            self.kojihub = \
                'http://{arch}.koji.clearos.com/kojihub'.format(
                    arch=arch)
        else:
            self.kojihub = 'https://koji.clearos.com/kojihub'
        self.serverca = os.path.expanduser('~/.koji/koji_ca_cert.crt')
        self.clientca = os.path.expanduser('~/.koji/koji_ca_cert.crt')
        self.clientcert = os.path.expanduser('~/.koji/usercert.pem')
